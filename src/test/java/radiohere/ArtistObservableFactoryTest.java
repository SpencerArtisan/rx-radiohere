...
public class ArtistObservableFactoryTest {
	...
	public void before() {
		...
		artistObservableFactory = new ArtistObservableFactory(gigObservableFactory, trackObservableFactory);
	}
	...
	public class WithTwoGigsFromSameArtistAndTwoTracks {
		...
		@Before
		public void before() {
			gig1 = new Gig("artist", "date1", "venue1", 42, null);
			gig2 = new Gig("artist", "date2", "venue2", 43, null);
			track1 = new Track("name1", "streamurl1");
			track2 = new Track("name2", "streamurl2");
