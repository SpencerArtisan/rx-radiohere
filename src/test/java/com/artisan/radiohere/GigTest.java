...
public class GigTest {
	...
	public void toJson() throws Exception {
		Gig gig = new Gig("Radiohead", "1-1-2001", "Scala", new Coordinate(51.5, -0.8), "songkick url");
		System.out.println(new JSONObject(gig));
	}
	
	@Test
	public void setDistance() throws Exception {
		Gig gig = new Gig("Radiohead", "1-1-2001", "Scala", Coordinate.YEATE_STREET, "songkick url");
